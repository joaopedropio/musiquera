...
interface AlbumProps {
	...
	release: Release;
	setCurrentReleaseType: (releaseType: string) => void;
}
const Album: React.FC<AlbumProps> = ({ release: release, setCurrentReleaseType: setCurrentReleaseType, setCurrentTrackUrl: setCurrentTrackUrl, highLightedTrack: highLightedTrack }) => {
	return (
		<div className='album'>
						...
						<thead style={{ borderBottom: '2px solid var(--surface2)' }}>
							...
							<tbody>
								{release.tracks.map(track => (
									<tr onClick={() => {setCurrentTrackUrl(track.file); setCurrentReleaseType('album')}} style={{ cursor: 'pointer' }}>
